<div class="modal fade" id="restaurantes">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
		        ...
		        <div class="modal-footer">
		          ...
		          <button type="submit" class="btn btn-primary" name="guardarRestaurantes">Guardar</button>
		          </form>
		        </div>
      		</div>
				</div><!-- /.modal-content -->
		...
		<?php
		 ...
		 $restaurantes->ingresarRestaurantescontroller();
